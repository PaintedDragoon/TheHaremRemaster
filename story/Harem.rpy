...
label scenario_Magic:
    ...
    menu:
        ...
        "Potions":
            ...
            kiyoshi "And the ingredients are easy to find, we have everything i need in the kitchen"
            hide kiyoshi with moveoutleft
            scene black
            with dissolve
        ...
        "Summoning":
            ...
            kiyoshi "There is just a swmall sentence in a strange language..."
...
label scenario_FOSE:
    show kiyoshi a_1
    kiyoshi "So if it work, anyone will swap body with the person they think during their orgasm.. It's cool!"
...
label scenario_Remote:
    ...
    kiyoshi "it look like it come in my direction!.."
    show white as white_flash:
        additive_flash(0.4)
    pause 0.8
    show white as white_flash:
    ...
    scene white
    with dissolve
    "But before I knew it, the alien tractor beam had enveloped me and I felt a sudden loss of gravity"
    "I was afraid but at the same time exited to meet with real aliens"
    scene black
    with dissolve
    "A powerful force then lifted me skywards and everything went blank"
    pause 2.0
